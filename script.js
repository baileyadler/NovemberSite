...
let userHouse = prompt("write your address");
let userTime = prompt("pick a time");
console.log(userName);

let myStory = ` <p> Hello! You are invited to <b>${userName}'s </b> Birthday party on <b>${userDate}.</b> Feel free to bring <b>${userFood} </b> to the <b>${userQuest}. </b> </p>

<p> Have fun celebrating <b>${userName}</b> at ${userPlace}. Make sure to arrive early to <b>${userPlace}. </b> At 6pm, we will leave <b>${userPlace}, </b> and travel on 
a <b>${userTravel}</b> to get dessert. </p>
 
<p> After getting icecream, <b>${userName} </b> will open up her gifts and hopes to receive <b>${userGift}.</b>
...
Please RSVP to <b>${userName}</b>55@gmail.com. </p> `;
